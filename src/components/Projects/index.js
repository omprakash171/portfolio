    ...
    const projects = [
      {
        ...
        link: "#",
        description:
          "A personal website showcasing my skills, projects, and achievements with a clean, responsive design.",
        points: [
      ...
      {
        title: "MERN Blog App",
        link: "https://omblog17.ccbp.tech/",
        description:
          "A full-stack blogging platform allowing users to create, edit, and view posts.",
        points: [
      ...
      },
      {
        ...
        description:
          "Custom Wikipedia search where users can view curated results and open detailed Wikipedia pages.",
        points: [
      ...
      },
      {
        ...
        description:
          "Typing speed assessment tool with real-time accuracy tracking.",
        points: [
